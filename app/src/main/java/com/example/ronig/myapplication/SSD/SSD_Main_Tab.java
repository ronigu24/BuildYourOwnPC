...
public class SSD_Main_Tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssd__main__tab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ssd__main__tab, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    SSD_Tab_1 tab1 = new SSD_Tab_1();
                    return tab1;

                case 1:
                    SSD_Tab_2 tab2 = new SSD_Tab_2();
                    return tab2;

                case 2:
                    SSD_Tab_3 tab3 = new SSD_Tab_3();
                    return tab3;

                case 3:
                    SSD_Tab_4 tab4 = new SSD_Tab_4();
                    return tab4;
