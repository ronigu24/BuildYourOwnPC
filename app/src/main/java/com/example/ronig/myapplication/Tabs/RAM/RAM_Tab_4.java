...
public class RAM_Tab_4 extends Fragment {
    Button Add_Ram_Tab_4_Button;
    TextView text;
    TextView price;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_memory_tab_4, container, false);


        Add_Ram_Tab_4_Button = (Button) rootView.findViewById(R.id.Add_Ram_Tab4);
        text = (TextView) rootView.findViewById(R.id.Text_Ram_Tab4);
        price =(TextView) rootView.findViewById(R.id.Price_Ram_Tab4);

        RAM_Main_Tab.Insert(text, price, 4);
