...
public class Memory_Main_Tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory__main__tab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_memory__main__tab, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    Memory_Tab_1 tab1 = new Memory_Tab_1();
                    return tab1;

                case 1:
                    Memory_Tab_2 tab2 = new Memory_Tab_2();
                    return tab2;

                case 2:
                    Memory_Tab_3 tab3 = new Memory_Tab_3();
                    return tab3;

                case 3:
                    Memory_Tab_4 tab4 = new Memory_Tab_4();
                    return tab4;
    ...
    public static void Insert(Context context, int tab, TextView text, TextView price){
        ...
        ArrayList<String> array = CPU_Main_Tab.db.fetch("ram");
