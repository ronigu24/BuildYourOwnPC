...
public class CPU_Main_Tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu__main__tab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cpu__main__tab, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    CPU_Tab_1 tab1 = new CPU_Tab_1();
                    return tab1;

                case 1:
                    CPU_Tab_2 tab2 = new CPU_Tab_2();
                    return tab2;

                case 2:
                    CPU_Tab_3 tab3 = new CPU_Tab_3();
                    return tab3;
