...
public class RAM_Main_Tab extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    RAM_Tab_1 tab1 = new RAM_Tab_1();
                    return tab1;

                case 1:
                    RAM_Tab_2 tab2 = new RAM_Tab_2();
                    return tab2;

                case 2:
                    RAM_Tab_3 tab3 = new RAM_Tab_3();
                    return tab3;

                case 3:
                    RAM_Tab_4 tab4 = new RAM_Tab_4();
                    return tab4;
