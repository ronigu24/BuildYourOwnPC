...
public class Case_Tab_4 extends Fragment {

    Button Add_Case_Tab_4_Button;
    TextView text;
    TextView price;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_case_tab_4, container, false);

        Add_Case_Tab_4_Button = (Button) rootView.findViewById(R.id.Add_Case_Tab4);
